    ...
    <div className="min-h-screen bg-[#1E1E1E] relative overflow-hidden">
      ...
      <div className="relative w-full min-h-screen z-10 lg:hidden">
        ...
        <div className="flex justify-between items-center p-4 bg-[#1E1E1E]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="w-[40px] h-[40px] flex items-center justify-center rounded-full bg-[#E7F0E6] relative">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 2.25C6.75 2.25 4.5 4.5 4.5 6.75V9L3.5 10.5V12H15V10.5L13.5 9V6.75C13.5 4.5 11.25 2.25 9 2.25Z" stroke="#2B180A" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
        ...
        <div className="bg-white rounded-t-[25px] p-4 -mt-1">
          ...
          <div className="space-y-4">
            {/* Profile Card - Mobile */}
            <div className="bg-white rounded-[20px] overflow-hidden shadow-md relative flex">
              {/* Green Background Section */}
              <div className="bg-gradient-to-r from-[#106A02] to-[#13A753] p-4 flex items-center w-[30%]">
                <div className="w-[60px] h-[60px] rounded-full border-[2px] border-white overflow-hidden">
                  <Image 
                    src="/images/profile.jpg" 
                    alt="Profile" 
                    width={60} 
              ...
              <div className="flex-1 p-4">
                <div className="flex justify-between items-center mb-3">
                  <div>
                    <h3 className="text-[16px] font-bold text-[#1E1E1E]">Bevely Piter</h3>
                    <p className="text-[12px] text-[#636363]">Weight Loss, Muscle Gain</p>
                  </div>
                  <button className="bg-[#13A753] hover:bg-[#0D8A40] transition-colors rounded-full text-white py-1.5 px-3 flex items-center gap-1.5">
                ...
                <div className="flex justify-between items-center">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-[#13A753] flex items-center justify-center">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M17 20.5H7C4 20.5 2 19 2 15.5V8.5C2 5 4 3.5 7 3.5H17C20 3.5 22 5 22 8.5V15.5C22 19 20 20.5 17 20.5Z" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                          <path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <span className="text-[14px] text-[#636363]">alex123@gmail.com</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[14px] text-[#636363]">+91 7854578232</span>
                    </div>
                  </div>
                  
                  {/* Logout Button */}
                  <button className="border border-[#f3f3f3] rounded-full py-1.5 px-4 text-[#FF0000] flex items-center justify-center gap-1.5 hover:bg-[#FFF5F5] transition-colors">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M8.90002 7.56001C9.21002 3.96001 11.06 2.49001 15.11 2.49001H15.24C19.71 2.49001 21.5 4.28001 21.5 8.75001V15.27C21.5 19.74 19.71 21.53 15.24 21.53H15.11C11.09 21.53 9.24002 20.08 8.91002 16.54" stroke="#FF0000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M15 12H3.62" stroke="#FF0000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M5.85 8.65002L2.5 12L5.85 15.35" stroke="#FF0000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <span className="text-[#FF0000] text-xs font-semibold">Logout</span>
                  </button>
                </div>
              </div>
            </div>
            
            {/* Edit Profile Section - Mobile */}
            <div className="bg-white rounded-[20px] p-4 shadow-md border border-gray-100">
              <h3 className="text-[16px] font-bold text-[#1E1E1E] mb-4">Edit Profile</h3>
              
              <div className="space-y-4">
                <div className="relative border border-gradient-to-b from-[#13A753] to-[#1E2120] rounded-[43px]">
                  <input 
                    type="text" 
                    placeholder="Your Name" 
                    className="w-full py-2 px-4 rounded-[43px] focus:outline-none text-[#636363] text-sm"
                  />
                </div>
              ...
              <div className="flex justify-center mt-5">
                <button className="bg-gradient-to-b from-[#13A753] to-[#1E2120] rounded-[50px] py-2.5 px-6 text-white text-sm">
                  Save Changes
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[20px] p-4 shadow-md border border-gray-100">
              <h3 className="text-[16px] font-bold text-[#1E1E1E] mb-4">Configure Data Retention</h3>
            ...
            {/* WhatsApp Integration Section - Mobile */}
            <div className="bg-white rounded-[20px] p-4 shadow-md border border-gray-100">
              <div className="flex justify-between items-center">
                <h3 className="text-[16px] font-bold text-[#1E1E1E]">Manage WhatsApp Integration</h3>
            ...
            {/* Weekly Resets Section - Mobile */}
            <div className="bg-white rounded-[20px] p-4 shadow-md border border-gray-100">
              <div className="flex justify-between items-center">
                <h3 className="text-[16px] font-bold text-[#1E1E1E]">Enable Weekly Resets</h3>
                ...
                <div className="relative">
                  <label className="flex items-center cursor-pointer">
                    <div className="relative">
                      ...
                      <div className="block bg-gradient-to-b from-[#13A753] to-[#1E2120] w-12 h-6 rounded-full"></div>
                      <div 
                        className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition transform duration-200 ease-in-out ${weeklyResetsEnabled ? 'translate-x-6' : 'translate-x-0'}`}
                      ></div>
                    </div>
                  </label>
                </div>
